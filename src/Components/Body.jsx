    ...
    const Body =()=>{
        return (
            ...
            <div className=" lg:flex-1 lg:order-1" >
                ...
                <p className=" font-lato text-gray-400">With Hoster, Get your website up and running is no less than Five minutes with most competative price.</p>
                <form action="" className=" flex flex-col gap-4 md:flex-row">
                    <input className=" rounded-md px-4 py-3 placeholder:text-gray-400" type="email" placeholder="Enter E-mail Adress" />
